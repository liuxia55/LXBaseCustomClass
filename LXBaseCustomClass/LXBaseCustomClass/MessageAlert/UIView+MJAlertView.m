...
//你要展示的背景颜色
#define RGB [UIColor colorWithRed:91/255.0 green:91/255.0 blue:91/255.0 alpha:1.0]
...
//    CGFloat yOffset = CGRectGetHeight(screenBounds) - notifierHeight - 2*kHeightFromBottom;
